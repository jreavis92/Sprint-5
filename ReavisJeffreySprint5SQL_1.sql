...
('Earthy Sandalwood Serenity', 'Grounding sandalwood for a tranquil space. Crafted in our Classic Soy Collection.');
go
...
('Autumn Spice Harvest', 'Warm cinnamon, nutmeg, and clove, encapsulating autumn. Featured in our Seasonal Favorites.');
go
...
('White Tea Infusion', 'Gentle and soothing white tea leaves. A serene offering from our Natural Simplicity Line.');
go
